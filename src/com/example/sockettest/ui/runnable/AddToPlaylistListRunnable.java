...
public class AddToPlaylistListRunnable implements Runnable {
	private final List<Song> playlist;
	private final List<Map<String,String>> playlistList;
	private final SimpleAdapter playlistAdapter;
	
	public AddToPlaylistListRunnable(List<Song> playlist, List<Map<String,String>> playlistList, SimpleAdapter playlistAdapter) {
